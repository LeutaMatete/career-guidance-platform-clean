...
const AdminRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('✅ Admin registration successful! Check your REAL email for verification link from Firebase.');
      navigate('/auth/admin/verify-email');
    } catch (err) {
  ...
  return (
    <div className="auth-container">
      <div className="auth-card">
        ...
        <p className="auth-subtitle">Join CareerGuide as an Admin - Real email verification required</p>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="form-notice">
            <p>📧 <strong>Real Email Required:</strong> You will receive a verification link from Firebase to activate your admin account.</p>
        ...
        <div className="auth-footer">
          <p>
            Already have an admin account? <Link to="/auth/admin/login">Sign In as Admin</Link>
          </p>
        </div>
      </div>
    </div>
