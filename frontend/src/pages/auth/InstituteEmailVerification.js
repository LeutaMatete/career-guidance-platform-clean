...
const InstituteEmailVerification = () => {
  ...
  return (
    <div className="auth-container">
      <div className="auth-card">
        <h2>Verify Your Institute Email</h2>
        <p className="auth-subtitle">
          We've sent a verification code to your email address.
          Please enter the code below to verify your institute account.
        </p>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <button
            ...
            disabled={loading}
          >
            {loading ? 'Verifying...' : 'Verify Institute Email'}
          </button>
        </form>
