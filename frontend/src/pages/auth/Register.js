  ...
  return (
    <div className="auth-container">
      <div className="auth-card">
        ...
        <p className="auth-subtitle">Join CareerGuide - Real email verification required</p>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="form-notice">
            <p><strong>Real Email Required:</strong> You will receive a verification link from Firebase to activate your account.</p>
